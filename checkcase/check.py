...
def check_special(p, n):
    special = {
        ...
        # 一楼西南区西北区 N 类跨区
        '00000399901204': '00000299900102',

        # 二夹层东北区 C,Q,R,S,U,V 类交界
        '00001099903606': '00000799900102',
        '00000799901105': '00000899903201',
        '00000899900105': '00000899902501',
        '00000999900106': '00001099900102',
        '00000899900105': '00000999902001',
        '00000899901805': '00000899901702',
